...
export class Backend implements backendInterface {
    ...
    async submitContactForm(arg0: string, arg1: string, arg2: string | null, arg3: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContactForm(arg0, arg1, to_candid_opt_n4(this._uploadFile, this._downloadFile, arg2), arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        phone: record_opt_to_undefined(from_candid_opt_n3(_uploadFile, _downloadFile, value.phone))
    };
}
function from_candid_vec_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<{
    name: string;
    email: string;
    message: string;
    phone: [] | [string];
    ...
    return value.map((x)=>from_candid_record_n2(_uploadFile, _downloadFile, x));
}
